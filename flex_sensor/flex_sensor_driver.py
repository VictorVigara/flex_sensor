...
class flexDriver(Node): 
    ...
    def __init__(self): 
        ...
        self.flex_conn = FlexSensorConnection(self.n_sensors, self.VCC, self.R_DIV, self.port, 
                                              self.logger)
        self.flex_conn.flex_sensors_initialization()
        
        self.flex_plot = FlexSensorPlot(self.flex_conn, self.radial_plot, self.linear_plot, self.timer_period, 
                                        self.n_sensors, self.sensor_locations, self.max_time_plot, 
