...
# Define the neural network for multi-task learning
...
if __name__ == "__main__":
    ...
    for epoch in range(num_epochs):
        ...
        if avg_val_loss < best_val_loss:
            ...
            torch.save(
                model.state_dict(), data_folder_path + "best_model_multi_task.pth"
            )
    ...
    # Load the best model
    model.load_state_dict(torch.load(data_folder_path + "best_model_multi_task.pth"))
